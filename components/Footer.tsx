      ...
      <div className='max-w-7xl mx-auto py-8 px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[200px]'>
        <div className=''>
          ...
          <p className='mt-4 text-sm'>
            O Unilab Student Chapter é o capítulo estudantil da Unilab vinculado à instituição americana The Optical Society (OSA)
