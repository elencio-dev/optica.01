          ...
          <SwiperSlide key={index}>
            <div className="relative w-full h-[600px]">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-10 md:px-20 lg:px-32 text-white w-full sm:w-3/4 lg:w-2/3">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 leading-snug text-white text-2xl text-white">
                  {slide.title}
                </h2>
                <p className="text-sm sm:text-base lg:text-lg font-medium mb-4 line-clamp-3 leading-snug">
                  {slide.excerpt}
                </p>
